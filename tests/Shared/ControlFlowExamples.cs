...
public static class ControlFlowExamples
{
    ...
    [
        ...
        new("WrongBooleanArrayLoad", ["ldc.i4.1", "newarr bool", "ldc.i4.0", "ldelem.i1", "pop",
            "ldc.i4.s 42", "ret"], false, "cannot access bool elements as int8"),
        new("WrongArrayValue", ["ldc.i4.1", "newarr string", "ldc.i4.0", "ldc.i4.1", "stelem.ref",
            "ldc.i4.s 42", "ret"], false, "stelem.ref needs object", Verification: "StackUnexpected"),
