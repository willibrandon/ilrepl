...
public static class ConstructorReflectionExamples
{
        ...
        bool generic = false)
    {
        ...
        if (flow == "return")
        {
            source += ".method private static class ConstructorInfo Find() {\n"
    ...
    private static string Lookup(string lookup, bool argument, bool privateConstructor, bool generic, bool binder)
    {
        ...
        if (lookup is "declared" or "as-type")
        {
            ...
            if (lookup == "as-type")
            {
                source += "callvirt instance class Type TypeInfo::AsType()\n";
            }
        }
        ...
        else
        {
            ...
            if (arity is "four" or "five")
            {
                source += binder ? "ldarg.0\n" : "ldnull\n";
            }
