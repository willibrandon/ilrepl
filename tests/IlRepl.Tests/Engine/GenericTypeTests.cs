...
public sealed class GenericTypeTests
{
    ...
    [
        ...
        ".method public instance void .ctor(!0 v) { ldarg.0; call instance void [System.Runtime]System.Object::.ctor(); ldarg.0; ldarg " +
        "v; stfld !0 class Box`1<!0>::Value; ldsfld int32 class Box`1<!0>::Made; ldc.i4 1; add; stsfld int32 class Box`1<!0>::Made; ret }",
    ...
    public void Generic_InstantiatedFromCells()
    {
        ...
        Assert.AreEqual(5,
            Run(session, "ldc.i4 5", "newobj instance void class Box`1<int32>::.ctor(!0)", "call instance !0 class Box`1<int32>::Get()"));
        Assert.AreEqual("s",
            Run(session, "ldstr \"s\"", "newobj instance void class Box`1<string>::.ctor(!0)",
            "call instance !0 class Box`1<string>::Get()"));
    ...
    {
        var session = Load(Box);
        Run(session, "ldc.i4 1", "newobj instance void class Box`1<int32>::.ctor(!0)", "pop", "ldc.i4 2",
            "newobj instance void class Box`1<int32>::.ctor(!0)", "pop");
    ...
    public void Generic_UsedByOtherDefinitions()
    {
        ...
        Assert.AreEqual(4,
            Run(session, "ldc.i4 4", "call class Box`1<int32> Wrap(int32)", "dup", "stsfld class Box`1<int32> Holder::B",
            "call instance !0 class Box`1<int32>::Get()"));
    ...
    public void GenericMethod_InAGenericType_MixesTypeAndMethodParameters()
    {
        var session = Load(
            ...
            "ldarg v; stfld !0 class Pair`1<!0>::V; ret }",
            ".method public instance !!0 Map<U>(class [System.Runtime]System.Func`2<!0, !!0> f) { ldarg f; ldarg.0; ldfld !0 class " +
            "Pair`1<!0>::V; callvirt instance !1 class [System.Runtime]System.Func`2<!0, !!0>::Invoke(!0); ret }",
            "}");
    ...
    public void GenericVirtualMethod_Dispatches()
    {
        ...
        Assert.AreEqual("derived",
            Run(session, "newobj instance void Derived::.ctor()", "ldc.i4 1", "callvirt instance string Base::Describe<int32>(!!0)"));
    }
    ...
    public void Generic_DerivesFromGenericSessionBase()
    {
        var session = Load(
            ...
            ".field public !0 V",
            ".method public instance void .ctor(!0 v) { ldarg.0; call instance void [System.Runtime]System.Object::.ctor(); ldarg.0; " +
            "ldarg v; stfld !0 class Base`1<!0>::V; ret }",
            "}",
            ...
            "}");
        Assert.AreEqual(8,
            Run(session, "ldc.i4 8", "newobj instance void class Derived`1<int32>::.ctor(!0)", "ldfld !0 class Base`1<int32>::V"));
    ...
    {
        var session = Load(".class public sequential sealed Opt`1<T> extends [System.Runtime]System.ValueType {", ".field public !0 Value",
            ".field public bool Has", "}");
        Assert.AreEqual(5,
            Run(session, ".locals init (valuetype Opt`1<int32> o)", "ldloca o", "ldc.i4 5", "stfld !0 valuetype Opt`1<int32>::Value",
            "ldloc o", "ldfld !0 valuetype Opt`1<int32>::Value"));
    ...
    public void RecursiveConstraint_AndConstrainedCall()
    {
        var session = Load(
            ...
            ".method public static !0 Of(!0 a, !0 b) { ldarga a; ldarg b; constrained. !0; callvirt instance int32 class " +
            "[System.Runtime]System.IComparable`1<!0>::CompareTo(!0); ldc.i4 0; bge L; ldarg b; ret; L: ldarg a; ret }",
            "}");
    ...
    public void Generic_FromACellTypeParameter()
    {
        var session = Load(Box);
        Assert.AreEqual(0,
            Run(session, ".typeparams (T)", ".typeargs (int32)", ".locals init (!!0 v)", "ldloc v",
            "newobj instance void class Box`1<!!0>::.ctor(!0)", "ldfld !0 class Box`1<!!0>::Value", "box !!0"));
    }
}
