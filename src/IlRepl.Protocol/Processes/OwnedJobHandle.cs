...
/// <summary>
/// Owns a Windows job handle whose final close terminates any remaining owned process descendants.
/// </summary>
internal sealed partial class OwnedJobHandle : SafeHandleZeroOrMinusOneIsInvalid
{
    /// <summary>
    /// Creates the empty handle required by native handle marshalling.
    /// </summary>
    public OwnedJobHandle() : base(ownsHandle: true)
    {
    }
