...
public static class HostLocator
{
    ...
    /// <summary>
    /// Finds the configured host assembly, then searches the tool's host directory and its own directory.
    /// </summary>
    ...
    /// <summary>
    /// Finds the configured or currently running <c>dotnet</c> muxer, then searches the executable path.
    /// </summary>
