...
/// <summary>
/// One generic parameter of a <c>.class</c> or of a generic <c>.method</c> inside one.
/// </summary>
/// <remarks>
/// It holds its name, its variance and special constraints, and the types it is constrained to.
/// </remarks>
