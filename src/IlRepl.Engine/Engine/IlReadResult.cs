...
/// <summary>
/// What a read produced: the instructions decoded, and the faults that stopped decoding or that a later check found.
/// </summary>
/// <remarks>
/// A damaged tail never hides a readable head.
/// </remarks>
