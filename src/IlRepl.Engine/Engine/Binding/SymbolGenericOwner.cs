    ...
    IReadOnlyList<(string Name, GenericParameterAttributes Attributes)> MethodParameters)
{
    ...
    {
        var (name, attributes) = index < TypeParameters.Count ? TypeParameters[index] : ("!" + SymbolRenderer.Number(index), GenericParameterAttributes.None);
    ...
    {
        var (name, attributes) = index < MethodParameters.Count ? MethodParameters[index] : ("!!" + SymbolRenderer.Number(index), GenericParameterAttributes.None);
    ...
    public SymbolGenericOwner WithMethod(DefinitionId method, IReadOnlyList<(string Name, GenericParameterAttributes Attributes)> parameters) =>
