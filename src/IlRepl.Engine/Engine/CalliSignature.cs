...
/// <summary>
/// The signature written after <c>calli</c>: calling convention, return type, parameter types, and any vararg call-site parameters.
/// </summary>
/// <remarks>
/// The calling convention is managed or unmanaged.
/// </remarks>
    ...
    Type[]? OptionalParameterTypes)
{
    ...
    /// </summary>
    /// <remarks>
    /// Under <c>instance explicit</c> the receiver is already the first parameter (ECMA-335 II.15.3), so it is not counted twice. The
    /// function pointer itself is popped in addition.
    /// </remarks>
